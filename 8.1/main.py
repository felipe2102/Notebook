...
def RecebeAulas(n_aulas, Aulas, DiaAula, Hr_Aulas):
    for c in range(n_aulas):
        db.InsereAulas(Aulas[c], DiaAula, Hr_Aulas[c])
...
def config_ter():
    DiaAula = "Segunda"
    Aulas = [
        conf_seg.lineEdit_1aula.text(),
        conf_seg.lineEdit_2aula.text(),
        conf_seg.lineEdit_3aula.text(),
        conf_seg.lineEdit_4aula.text(),
        conf_seg.lineEdit_5aula.text(),
        conf_seg.lineEdit_6aula.text()
    ]
    n_aulas = 5
    if conf_seg.lineEdit_6aula.text() != '':
        n_aulas = 6

    RecebeAulas(n_aulas, Aulas, DiaAula, Hr_Aulas)
    conf_seg.hide()
    conf_ter.show()
...
def config_qua():
    DiaAula = "Terça"
    Aulas = [
        conf_ter.lineEdit_1aula.text(),
        conf_ter.lineEdit_2aula.text(),
        conf_ter.lineEdit_3aula.text(),
        conf_ter.lineEdit_4aula.text(),
        conf_ter.lineEdit_5aula.text(),
        conf_ter.lineEdit_6aula.text()
    ]
    n_aulas = 5
    if conf_ter.lineEdit_6aula.text() != '':
        n_aulas = 6
...
def config_qui():
    DiaAula = "Quarta"
    Aulas = [
        conf_qua.lineEdit_1aula.text(),
        conf_qua.lineEdit_2aula.text(),
        conf_qua.lineEdit_3aula.text(),
        conf_qua.lineEdit_4aula.text(),
        conf_qua.lineEdit_5aula.text(),
        conf_qua.lineEdit_6aula.text()
    ]
    n_aulas = 5
    if conf_qua.lineEdit_6aula.text() != '':
        n_aulas = 6
...
def config_sex():
    DiaAula = "Quinta"
    Aulas = [
        conf_qui.lineEdit_1aula.text(),
        conf_qui.lineEdit_2aula.text(),
        conf_qui.lineEdit_3aula.text(),
        conf_qui.lineEdit_4aula.text(),
        conf_qui.lineEdit_5aula.text(),
        conf_qui.lineEdit_6aula.text()
    ]
    n_aulas = 5
    if conf_qui.lineEdit_6aula.text() != '':
        n_aulas = 6
...
def config_ends():
    DiaAula = "Sexta"
    Aulas = [
        conf_sex.lineEdit_1aula.text(),
        conf_sex.lineEdit_2aula.text(),
        conf_sex.lineEdit_3aula.text(),
        conf_sex.lineEdit_4aula.text(),
        conf_sex.lineEdit_5aula.text(),
        conf_sex.lineEdit_6aula.text()
    ]
    n_aulas = 5
    if conf_sex.lineEdit_6aula.text() != '':
        n_aulas = 6
...
def editarCompromisso():
    ...
    db.editarCompromisso(titulo_Antigo, Tipo_Antigo,
                         Titulo_Novo, Tipo_Novo, Descrição_Nova)
    agendaSQLite()
    editar_evento.hide()
    agenda.show()
...
registra = uic.loadUi("pages/Registro.ui")
Login = uic.loadUi("pages/login.ui")

# Carrega as janelas principais do programa
home = uic.loadUi("pages/index.ui")
agenda = uic.loadUi("pages/agenda.ui")
configuraçao = uic.loadUi("pages/configuração.ui")
aulas = uic.loadUi("pages/aulas.ui")
novo_evento = uic.loadUi("pages/novo_compromisso.ui")
editar_evento = uic.loadUi("pages/editar_compromisso.ui")
buscar_evento = uic.loadUi("pages/deletar_compromisso.ui")
deletar_evento = uic.loadUi("pages/deletar_compromisso.ui")

# Carrega as janelas de configuração
conf_seg = uic.loadUi("pages/aulas_segunda.ui")
conf_ter = uic.loadUi("pages/aulas_terça.ui")
conf_qua = uic.loadUi("pages/aulas_quarta.ui")
conf_qui = uic.loadUi("pages/aulas_quinta.ui")
conf_sex = uic.loadUi("pages/aulas_sexta.ui")
