...
lessons = uic.loadUi("./_pages/aulas.ui")
compromisses = uic.loadUi("./_pages/agenda.ui")
configurations = uic.loadUi("./_pages/configuração.ui")
conf_lessons_segunda = uic.loadUi("./_pages/aulas_segunda.ui")
conf_lessons_terça = uic.loadUi("./_pages/aulas_terça.ui")
conf_lessons_quarta = uic.loadUi("./_pages/aulas_quarta.ui")
conf_lessons_quinta = uic.loadUi("./_pages/aulas_quinta.ui")	
conf_lessons_sexta = uic.loadUi("./_pages/aulas_sexta.ui")
